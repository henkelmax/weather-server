    ...
    <v-card>
      <v-card-text>
        <div class="privacy">
          ...
          <p>
            Folgende Organisationen, Unternehmen bzw. Personen wurden vom Betreiber dieser Website mit der Verarbeitung
          ...
          <p>
            ...
            die für den Datenschutz verantwortliche Person.
          </p>
          <br />
          <p>
            <em>
