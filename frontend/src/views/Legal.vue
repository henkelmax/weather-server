    ...
    <v-card>
      <v-card-text>
        <div class="imprint">
          ...
          <br />
          <div>
            <img src="@/assets/address.svg" height="75px" alt="address" />
          </div>
          <br />
          <div>
            <h2>Kontakt:</h2>
            E-Mail:
            <br />
            <img src="@/assets/mail.svg" height="16px" alt="mail" />
          </div>
          <br />
          <br />
          <div>
            ...
            <br />
            <br />Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit
          ...
          <br />
          <a href="https://www.impressum-generator.de/impressum-generator/" target="_blank" rel="nofollow noopener"
            >Quelle</a
          >
        </div>
      </v-card-text>
